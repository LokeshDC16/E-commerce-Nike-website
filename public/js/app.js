...
function updateCart(shoes) {
  axios__WEBPACK_IMPORTED_MODULE_2__["default"].post('/update-cart', shoes).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    console.log(e);
    var shoes = JSON.parse(btn.dataset.shoes);
    updateCart(shoes);
  });
});
...
function updateStatus(order) {
  ...
  var stepCompleted = true; //first status will be always true i.e gray
  statuses.forEach(function (status) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunknewe_commerce"] = self["webpackChunknewe_commerce"] || [];
